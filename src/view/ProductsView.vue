    ...
    <section>
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <ul class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <li v-for="(item, index) in allProducts" :key="index" @click="viewProduct(item.id)">
                    <a href="#" class="group block overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1523381210434-271e8be1f52b?auto=format&amp;fit=crop&amp;q=80&amp;w=1160"
                            alt=""
                        ...
                        <div class="relative bg-white pt-3">
                            ...
                            <p class="mt-2">
                                ...
                                <span class="tracking-wider text-gray-900"> {{ item.price }} </span>
                            </p>
                        </div>
                    </a>
                </li>
